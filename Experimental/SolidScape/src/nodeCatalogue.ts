...
[
    ...
    //---------------------------------------------------------------- Primitives
    {
        id: 'sdf-sphere', name: 'SDF Sphere', kind: 'Primitive', glyph: 'sdf', group: 'Primitives',
        desc: 'Signed distance sphere',
        inputs:  [P('centre', 'Centre', 'vector')],
        outputs: [P('sdf', 'Distance', 'field')],
        params:  [V('radius', 'Radius', 0.1, 400, 0.1, 24, ' m')],
    },
    {
        id: 'sdf-box', name: 'SDF Box', kind: 'Primitive', glyph: 'sdf', group: 'Primitives',
        desc: 'Rounded signed distance box',
        inputs:  [P('centre', 'Centre', 'vector')],
        outputs: [P('sdf', 'Distance', 'field')],
        params:  [V('extent', 'Extent', 0.1, 400, 0.1, 30, ' m'), V('round', 'Round', 0, 30, 0.1, 2.5, ' m')],
    },
    {
        id: 'sdf-plane', name: 'SDF Plane', kind: 'Primitive', glyph: 'sdf', group: 'Primitives',
        desc: 'Infinite half-space',
        inputs:  [P('normal', 'Normal', 'vector')],
        outputs: [P('sdf', 'Distance', 'field')],
        params:  [V('offset', 'Offset', -200, 200, 0.1, 0, ' m')],
    },
    {
        id: 'sdf-cylinder', name: 'SDF Cylinder', kind: 'Primitive', glyph: 'sdf', group: 'Primitives',
        desc: 'Capped cylinder field',
        inputs:  [P('centre', 'Centre', 'vector')],
        outputs: [P('sdf', 'Distance', 'field')],
        params:  [V('radius', 'Radius', 0.1, 200, 0.1, 12, ' m'), V('height', 'Height', 0.1, 400, 0.1, 40, ' m')],
    },
    ...
    {
        id: 'erode', name: 'Hydraulic Erosion', kind: 'Deformer', glyph: 'erosion', group: 'Deformers',
        desc: 'Water-driven sediment transport',
        inputs:  [P('in', 'Field', 'field'), P('rain', 'Rainfall', 'scalar')],
        outputs: [P('out', 'Field', 'field'), P('flowMap', 'Flow', 'field')],
        params:  [V('iterations', 'Iters', 1, 512, 1, 128), V('deposition', 'Deposit', 0, 1, 0.01, 0.3),
                  V('evaporation', 'Evap', 0, 1, 0.01, 0.12)],
    },
    {
