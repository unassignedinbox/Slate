...
struct TelemetryRowStructure
{
    ...
    bool        ShowGpuStages = false;// "Show GPU Stage Timings" — ReSTIR / Raster / Resolve / Post
...
public:
    ...
    void AssignGpuTimings(const TelemetryGpuTimings& Timings) noexcept { GpuTimings = Timings; }
    [[nodiscard]] const TelemetryGpuTimings& QueryGpuTimings() const noexcept { return GpuTimings; }
...
private:
    ...
    TelemetryGpuTimings   GpuTimings;
